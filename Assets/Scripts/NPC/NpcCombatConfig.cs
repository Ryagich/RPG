...
namespace NPC
{
    ...
    public sealed class NpcCombatConfig : ScriptableObject
    {
        ...
        [field: SerializeField, Min(0f)] public float SpacingRetreatCooldown { get; private set; } = 0.8f;
        ...
        [field: SerializeField, Min(1)] public int MaxConsecutiveSpacingRetreats { get; private set; } = 1;
        ...
        [field: SerializeField, Min(0.1f)] public float EvasionStateTimeout { get; private set; } = 1.35f;
        ...
        [field: SerializeField, Range(0f, 1f)] public float ApproachBurstBaseChance { get; private set; } = 0.4f;
        ...
        [field: SerializeField, Range(0f, 1f)] public float PostAttackImmediateAttackWeight { get; private set; } = 0.45f;
        ...
        [field: SerializeField, Range(0f, 1f)] public float PostAttackStrafeWeight { get; private set; } = 0.25f;
        ...
        [field: SerializeField, Range(0f, 1f)] public float PostAttackBackstepWeight { get; private set; } = 0.2f;
        ...
        [field: SerializeField, Range(0f, 1f)] public float PostAttackCircleWeight { get; private set; } = 0.1f;
        ...
        [field: SerializeField, Range(0f, 1f)] public float PostAttackWaitWeight { get; private set; } = 0.12f;
        ...
        [field: SerializeField, Range(0f, 1f)] public float PostAttackKeepDistanceWeight { get; private set; } = 0.18f;
        ...
        [field: SerializeField, Range(0f, 1f)] public float AttackRepetitionPenalty { get; private set; } = 0.65f;
        ...
        [field: SerializeField, Min(1)] public int MaxConsecutiveAttackDecisions { get; private set; } = 2;
        ...
        [field: Tooltip("Задержка перед новой атакой после входа в режим удержания дистанции. Не даёт NPC мгновенно отменить собственное выжидание.")]
